...
int track_mclinks(const char* input, const char* output, int pdg_number) {
    ...
    //gPad->SetLogy();
    c_track_theta->Draw();
    c_track_theta->SaveAs("plots/trk_electrons/ElectronRate_theta_trwgt.pdf"); 
    ...
    //gPad->SetLogy();
    c_track_pt->Draw();
    c_track_pt->SaveAs("plots/trk_electrons/ElectronRate_pt_trwgt.pdf");
    ...
    //gPad->SetLogy();
    c_track_p->Draw();
    c_track_p->SaveAs("plots/trk_electrons/ElectronRate_p_trwgt.pdf");
    ...
    //gPad->SetLogy();
    c_other_theta->Draw();
    c_other_theta->SaveAs("plots/trk_electrons/NotReconstructed_theta_trwgt.pdf");
    ...
    //gPad->SetLogy();
    c_other_pt->Draw();
    c_other_pt->SaveAs("plots/trk_electrons/NotReconstructed_pt_trwgt.pdf");
    ...
    //gPad->SetLogy();
    c_other_p->Draw();
    c_other_p->SaveAs("plots/trk_electrons/NotReconstructed_p_trwgt.pdf");
